...
public class AxolangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "T__21", "T__22", "IDENTIFIER", "CHAR_LITERAL", 
			"STRING_LITERAL", "INT_LITERAL", "UINT_LITERAL", "FLOAT_LITERAL", "DECIMAL_LITERAL", 
	...
	public AxolangLexer(CharStream input) {
		super(input);
